    ...
    return(
        <div>
          ...
          <div className="w-full flex flex-wrap justify-evenly px-4 my-6 gap-y-6 border-2 border-gray-200 p-4">
              ...
              <Image src="/self-help.jpg" alt="self-help" width={500} height={500} className="w-36 h-60 mx-auto" />
              ...
              <div className="w-1/2 lg:w-1/4 text-center">
              <Image src="/Philosophy.jpg" alt="Philosophy" width={500} height={500} className="w-36 h-60 mx-auto" />
          ...
          <div className="w-full flex flex-wrap justify-evenly px-4 my-6 gap-y- border-2 border-gray-200 p-4">
              ...
              <div className="w-1/2 lg:w-1/4 text-center">
              <Image src="/new2.jpg" alt="book2" width={500} height={500} className="w-36 h-60 mx-auto" />
              ...
              <div className="w-1/2 lg:w-1/4 text-center">
              <Image src="/new3.jpg" alt="book3" width={500} height={500} className="w-36 h-60 mx-auto" />
              ...
              <div className="w-1/2 lg:w-1/4 text-center">
              <Image src="/new4.jpg" alt="book4" width={500} height={500} className="w-36 h-60 mx-auto" />
